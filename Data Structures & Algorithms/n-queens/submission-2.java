class Solution {
    ...
    //Time complexity -> O(n!) for each index we have n possibilites and for next n-1 possibilites
    //space -> O(n + 2n + n^2*S) where S is the number of solution, each S will require a board
